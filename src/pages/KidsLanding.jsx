...
const KidsLanding = () => {
    ...
    const kidsCategory = categoryTree.find(cat => cat.name.toLowerCase() === 'kids');
    const subCategories = kidsCategory?.children || [];
    ...
    return (
        <div className="min-h-screen bg-white">
            {/* Hero Banner */}
            <div className="relative h-[50vh] min-h-[400px] bg-gradient-to-r from-blue-500 to-purple-600 overflow-hidden">
                <div
                    className="absolute inset-0 bg-cover bg-center opacity-50"
                    style={{
                        backgroundImage: "url('https://images.unsplash.com/photo-1503919545889-aef636e10ad4?w=1920&h=1080&fit=crop')"
                    }}
                />
                <div className="relative z-10 h-full flex flex-col justify-center items-center text-white px-4 text-center">
                    <h1 className="text-5xl md:text-7xl font-bold mb-4 tracking-tight">KIDS</h1>
                    <p className="text-xl md:text-2xl font-light mb-8 max-w-2xl">
                        Fun and stylish fashion for the little ones
                    </p>
                    <Link
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                <nav className="flex items-center gap-2 text-sm text-gray-500">
                    ...
                    <span className="text-black font-medium">Kids</span>
                </nav>
            </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
                        {subCategories.map(subCat => (
                            ...
                            >
                                ...
                                <img
                                    src={subCat.image || `https://images.unsplash.com/photo-1503919545889-aef636e10ad4?w=400&h=400&fit=crop`}
                                    alt={subCat.name}
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="flex items-center justify-between mb-8">
                    ...
                    <Link
                        to={`/products?category=${activeSubCategory || 'Kids'}`}

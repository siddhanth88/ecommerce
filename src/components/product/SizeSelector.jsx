 ...
 * @param {Array} props.availableSizes - Sizes with stock > 0
 */
const SizeSelector = ({ sizes, selectedSize, onSelectSize, stock = 100, error = false, availableSizes = [] }) => {
  return (
    <div className="space-y-3">
      ...
      <div className="flex flex-wrap gap-2">
        {sizes.map((size) => {
          ...
          // If availableSizes is provided, use it; otherwise fallback to stock > 0
